...
<body >
    ...
    <form class="form-horizontal container" action="#" methode="post">
        <div class="input-group col-sm-12">
          <input type="text" class="form-control" name="kw" placeholder="ค้นหา...">
    ...
    if ($result->num_rows == 0) {
        ...
        while($row = $result->fetch_object()){ 
            ...
            $table.= "<td>";
            $table.= "<a href='file.php?id=$row->id'><span class='fa fa-folder' aria-hidden='true'></span></a>";
            $table.= "<td>";
            $table.= "<a href='edit.php?id=$row->id'><span class='fa fa-edit' aria-hidden='true'></span></a>";
            $table.= " | ";
            $table.= "<a href='delete.php?id=$row->id'><span class='glyphicon glyphicon-trash' aria-hidden='true'></span></a>";
            $table.= "</td>";
            $table.= "<td>";
            $table.= "<a href='staff.php?id=$row->id'><span class='fa fa-group' aria-hidden='true'></span></a>";
            $table.= "</td>";
            $table.= "</tr>";
        }
