...
if ($_POST){
    ...
    // The argument may be one of four types: ##การกำหนดค่าของตัวหนังสือที่จะใส่ค่าสถานะเช่น ชื่อ กำหนด เป็น string ตัวเลข กำหนดเป็น integer
    //  i - integer
    //  d - double
    //  s - string
    //  b - BLOB
    ...
    <div class="container">
        ...
        <form action="add.php" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="doc_num" id="doc_num" placeholder="ตัวอย่าง.1001">
            </div>
            <div class="form-group">
                <label for="doc_title">ชื่อคำสั่ง</label>
                <input type="text" class="form-control" name="doc_title" id="doc_title" placeholder="ตัวอย่าง.เคน เลย์">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="doc_status" id="doc_status" placeholder="ตัวอย่าง.กรรมการ หรือ Manager">
            </div>
            <div class="form-group">
