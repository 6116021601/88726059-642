...
<body>
    <div class="container">
        <h1>เพิ่มสมาชิกบุคลากร</h1>
        <form action="addstaff.php" method="post">
            <div class="form-group">
                <label for="stf_code">เลขที่คำสั่ง</label>
                <input type="text" class="form-control" name="stf_code" id="stf_code" placeholder="ตัวอย่าง.1001">
            </div>
            <div class="form-group">
                <label for="stf_name">ชื่อ - นามสกุล</label>
                <input type="text" class="form-control" name="stf_name" id="stf_name" placeholder="ตัวอย่าง.เเจ็ค สตีฟ">
            </div>
